...
globalkeys = gears.table.join(
    ...
    -- Applications
    awful.key({ alt,           }, "r", function () awful.spawn("rofi -show drun") end,
    ...
    awful.key({ alt,           }, "a", function () awful.spawn("anki") end,
        {description = "anki", group = "applications"}),
    awful.key({ alt,           }, "o", function () awful.spawn("md.obsidian.Obsidian") end,
        {description = "obsidian", group = "applications"}),
    awful.key({ alt,           }, "c", function () awful.spawn("gnome-calculator") end,
        {description = "calculator", group = "applications"}),

    -- Screenshots
    awful.key({           }, "Print", function () awful.spawn("flameshot screen -c -p /home/pinto/Pictures/Screenshots/") end,
