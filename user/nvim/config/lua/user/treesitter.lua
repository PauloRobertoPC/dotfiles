...
configs.setup {
    ensure_installed = {"c", "cpp", "rust", "python", "java", "javascript", "lua", "html", "css", "markdown", "markdown_inline"}, -- one of "all", "maintained" (parsers with maintainers), or a list of languages
